...
const PAGE_ID = 327; // la site "courses/synthesis-and-sound-design"

// Same treatment already applied to the DJ, Ableton Live, and Logic Pro
// course pages (ids 322, 329, 328) - see move-dj-text-up.ts,
// fix-ableton-enroll-block.ts, fix-logic-pro-enroll-block.ts:
...
// 2. Shift the price/enrollment block 32px higher (16px + a further 16px,
//    matching the total applied to the other course pages) without moving
//    the JOIN NOW button below it: margin-top: -32px on the first
//    [vc_column_text] pulls it (and everything below, in normal flow) up
//    32px; margin-bottom: 32px on the second gives that 32px back before
//    the button, so only this block moves.
const OLD_BLOCK =
  `[vc_column_text css=""]\r\n` +
  `<h1 style="text-align: center"><span style="color: #ffffff">Synthesis and Sound Design (24 Hrs): </span></h1>\r\n` +
...
const NEW_BLOCK =
  `[vc_column_text css=".vc_custom_1770300001111{margin-top: -32px !important;}"]\r\n` +
  `<h1 style="text-align: center"><span style="color: #ffffff !important">Synthesis and Sound Design (24 Hrs): </span></h1>\r\n` +
  ...
  `[/vc_column_text][vc_empty_space][vc_column_text css=".vc_custom_1770300002222{margin-bottom: 32px !important;}"]\r\n` +
