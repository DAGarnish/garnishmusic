...
// mia's /courses/logic-course/ -> product/logic-course (see
// COURSE_SCHEDULE_PAGES in app/(frontend)/[[...slug]]/page.tsx).
const PRODUCT_ID = 67;
const EXPECTED_SHA256 = "6337ddaa520f4d68e2a7bb8d021d5947def5d40741b1667ca214734ac082cf44";

// Same fix as scripts/add-balance-due-note-ableton-live-course.ts: adds a
// "balance due before start date" line to the early-bird/repeat-student
// discount blurb, splitting it into its own sentence between the
