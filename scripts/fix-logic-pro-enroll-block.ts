...
const PAGE_ID = 328; // la site "courses/logic-pro-course"

// Same two fixes already applied to the DJ course (id 322) and Ableton Live
// course (id 329) pages, see move-dj-text-up.ts / fix-ableton-enroll-block.ts:
...
const OLD_BLOCK =
  `[vc_column_text css=""]\r\n` +
  `<h1 style="text-align: center"><span style="color: #ffffff">Logic Pro Course (24 Hrs): </span></h1>\r\n` +
...
const NEW_BLOCK =
  `[vc_column_text css=".vc_custom_1770200001111{margin-top: -16px !important;}"]\r\n` +
  `<h1 style="text-align: center"><span style="color: #ffffff !important">Logic Pro Course (24 Hrs): </span></h1>\r\n` +
  ...
  `[/vc_column_text][vc_empty_space][vc_column_text css=".vc_custom_1770200002222{margin-bottom: 16px !important;}"]\r\n` +
