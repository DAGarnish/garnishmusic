...
// Another 16px on top of the -16px shift from fix-logic-pro-enroll-block.ts,
...
const OLD_FIRST = `.vc_custom_1770200001111{margin-top: -16px !important;}`;
const NEW_FIRST = `.vc_custom_1770200001111{margin-top: -32px !important;}`;

const OLD_SECOND = `.vc_custom_1770200002222{margin-bottom: 16px !important;}`;
const NEW_SECOND = `.vc_custom_1770200002222{margin-bottom: 32px !important;}`;
